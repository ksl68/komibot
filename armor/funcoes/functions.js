...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL : https://youtube.com/channel/UCx8b3HdonWrA71fDUCXLxqw"]}
...
const banner2 = cfonts.render(('Canal: https://youtube.com/channel/UCx8b3HdonWrA71fDUCXLxqw'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`KOMI MD 2.0`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'KOMI-MD-2.0'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'KOMI-MD-2.0';	
